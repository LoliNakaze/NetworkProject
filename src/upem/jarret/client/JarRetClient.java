...
public class JarRetClient {
    ...
    static String createContentWithoutLastLine(ServerAnswer sa) {
        return "{\"JobId\": \"" + sa.getJobId() + "\", \"WorkerVersion\": \"" +
                sa.getWorkerVersion() + "\", \"WorkerURL\": \"" + sa.getWorkerURL() +
                "\", \"WorkerClassName\": \"" + sa.getWorkerClassName() + "\", \"Task\": \"" +
                sa.getTaskNumber() + "\", \"ClientId\": \"" + sa.getClientId() + "\",";
    }
    ...
    private static ByteBuffer createBufferToSend(String host, ServerAnswer serverAnswer, String contentWithoutLastLine,
        ...
        try {
            buffToSend.put(UTF8.encode(contentToSend));
